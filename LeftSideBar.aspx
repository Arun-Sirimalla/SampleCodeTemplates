...
<link rel="stylesheet" type="text/css" href="https://i81.sharepoint.com/sites/ilab/_catalogs/masterpage/custom_masterpage/css/leftsidebar.css">

	<div id="DeltaPlaceHolderMain" class="row">
	<div id="leftColumn" class="col-lg-2 col-md-2 col-sm-2 col-xs-12"  >
		<div class="col-md-12 customborder contentDiv">
	...
	<div id="rightColumn" class="col-lg-10  col-md-10 col-sm-10 col-xs-12">
		<div class="col-md-12 contentDiv">
			<PublishingWebControls:RichHtmlField FieldName="6ef2262b-355d-4f71-bc9c-ca85e46f9ffd" runat="server"></PublishingWebControls:RichHtmlField>
		</div>
	</div>
</div>
